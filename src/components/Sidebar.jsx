...
const Sidebar = () => {
    const { scrollTarget, setScrollTarget, setPage, page, sidebarText, setSidebarText, handleScrollTo, sidebarIcon, setSidebarIcon, sidebarNumber, setSidebarNumber, sidebarIconAmount, setSidebarIconAmount, isVisible, setIsVisible, activePage } = useGlobalContext();
                ...
                {cartPopup && (
                    <div className="cart-modal">
                        ...
                        <div className="cart-items">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque sed eligendi tempora. Accusantium distinctio enim minus labore officiis, tempora natus!</p>
                        </div>
                        <div className="cart-foot">
                            <button className="clear-btn">Clear All</button>
                            <button className="add-cart-btn small-btn checkout-btn">checkout</button>
                        </div>
                    </div>
                )}
            </div>
